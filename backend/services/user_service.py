...
class UserService(BaseService):
    ...
    def add_user(self, username: str, age: int, display_name: str, password: str, completed_activity_count: int = 0, profile_picture: str = '', rating: float = None):
        user = self.parse_user(username=username, age=age, display_name=display_name, password=password, completed_activity_count=completed_activity_count, profile_picture=profile_picture, rating=rating)
    ...
    def parse_user(self, username: str, age: int, display_name: str, password: str, completed_activity_count: float, profile_picture: str = '', rating: float = None):
        return User(username=username, age=age, display_name=display_name, password=password,
                    completed_activity_count=completed_activity_count, profile_picture=profile_picture, rating=rating)
